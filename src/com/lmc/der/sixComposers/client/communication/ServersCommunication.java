...
public class ServersCommunication {	
	private static final RequestBuilder FetchRequestBuilder;
	...
	public static final void callFetchServlet(String path,String defaultValue,RequestCallback callbackObj){
...
//		return FetchResult;
	...
	public static final void callFetchServlet(TableRequestCallback callbackObj){
	...
	public static class TableRequestCallback implements RequestCallback{
