...
public class HershTable8 extends FSTRA2FlexTable {
	
	public HershTable8(int tableNumber){
		initRows =  8;columns=21;headerRows=3;headerColumns=1;		
		BasePath = "HA||ResultsAndDiscussion";
		this.setText(0, 0, "Hormone");
		this.setText(0, 1, "Dose (mg/kg bw/day)");
		CFormatter.setRowSpan(0, 0,  3);
		CFormatter.setColSpan(0, 1, 20);
		...
		if (tableNumber==8){
			...
			fillRowTextBoxes(6,new String[0],1,"15ex","5ex");
			fillRowTextBoxes(7,new String[0],1,"15ex","5ex");
		}else{
			BasePath += ">>Table10";
