...
public class FSTRATable9 extends AMA2FlexTable {
	
	public FSTRATable9(){
		initRows = 4;columns=7;headerRows=2;headerColumns=1;
		BasePath="FSTRA||ResultsAndDiscussion>>Survival>>ResultsTable";
		...
		this.setText(1, 0, "n");
		this.setText(1, 1, "Surviving #");
		this.setText(1, 2, "Survival %");
		this.setText(1, 3, "n");
		this.setText(1, 4, "Surviving #");
		this.setText(1, 5, "Survival %");
